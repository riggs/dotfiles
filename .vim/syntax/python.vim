...
" Modified by Benjamin Riggs <deisum@gmail.com>
" Filenames:	*.py
"
...
syn region  pythonFunc start="^\s*def\>" end=")\s*:" keepend contains=pythonFuncDef,pythonFuncName,pythonFuncParams,pythonMagicFuncName
syn keyword pythonFuncDef def contained nextgroup=pythonFuncName,pythonMagicFuncName skipwhite
syn match   pythonFuncName	"[a-zA-Z_][a-zA-Z0-9_]*" display contained nextgroup=pythonFuncParams skipwhite
syn match   pythonMagicFuncName "__\h\w*__" display contained nextgroup=pythonFuncParams skipwhite
syn region  pythonFuncParams start="("ms=s+1 end=")"me=e-1 contained transparent contains=pythonParam 
syn region  pythonParam start="[a-zA-Z_]" end="\(,\|)\s*:\)" contained contains=pythonSelf,pythonParamName,pythonParamDefault,pythonDefaultAssignment transparent nextgroup=pythonParam
...
syn match   pythonParamDefault "=\@<=[^,]*" contained transparent contains=@pythonStringType,@pythonNumberType,@pythonBuiltin,pythonSelf
...
syn region pythonString		start=+"+ skip=+\\\\\|\\"\|\\$+ excludenl end=+"+ end=+$+ keepend contains=pythonEscape,pythonEscapeError,@Spell
syn region pythonString		start=+"""+ end=+"""+ keepend contains=pythonEscape,pythonEscapeError,pythonDocTest2,pythonSpaceError,@Spell,pythonComment
syn region pythonString		start=+'''+ end=+'''+ keepend contains=pythonEscape,pythonEscapeError,pythonDocTest,pythonSpaceError,@Spell,pythonComment
...
syn region pythonUniString	start=+[uU]"+ skip=+\\\\\|\\"\|\\$+ excludenl end=+"+ end=+$+ keepend contains=pythonEscape,pythonUniEscape,pythonEscapeError,pythonUniEscapeError,@Spell
syn region pythonUniString	start=+[uU]"""+ end=+"""+ keepend contains=pythonEscape,pythonUniEscape,pythonEscapeError,pythonUniEscapeError,pythonDocTest2,pythonSpaceError,@Spell,pythonComment
syn region pythonUniString	start=+[uU]'''+ end=+'''+ keepend contains=pythonEscape,pythonUniEscape,pythonEscapeError,pythonUniEscapeError,pythonDocTest,pythonSpaceError,@Spell,pythonComment
...
syn region pythonRawString	start=+[rR]"+ skip=+\\\\\|\\"\|\\$+ excludenl end=+"+ end=+$+ keepend contains=pythonRawEscape,@Spell
syn region pythonRawString	start=+[rR]"""+ end=+"""+ keepend contains=pythonDocTest2,pythonSpaceError,@Spell,pythonComment
syn region pythonRawString	start=+[rR]'''+ end=+'''+ keepend contains=pythonDocTest,pythonSpaceError,@Spell,pythonComment
...
if exists("python_highlight_builtins") && python_highlight_builtins != 0
  ...
  syn keyword pythonBuiltinObj	Ellipsis object
  syn keyword pythonBuiltinObj	__debug__ __doc__ __file__ __name__ __package__ __all__ __slots__ __future__

  syn match   pythonBuiltinFunc "__\h\w*__"
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  HiLink pythonMagicFuncName Structure
